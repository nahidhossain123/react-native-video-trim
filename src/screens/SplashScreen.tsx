...
const SplashScreen = ({ navigation }) => {
    ...
    const flatListRef = useRef<FlatList<OnboardingDataType>>()
        ...
        <View style={styles.container}>
            ...
            <View style={{ position: 'absolute', bottom: 0, width: '100%', justifyContent: 'flex-end', gap: 20, marginBottom: 10, paddingHorizontal: 10 }}>
                ...
                <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
                    ...
                    }} style={{ borderRadius: 200, paddingHorizontal: 30, color: '#000000', backgroundColor: '#FFF', flexDirection: "row", gap: 10 }}>
                        Continue
                    </ThemeButton>
                </View>
            </View>
